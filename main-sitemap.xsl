			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - AI Tools for Education</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - AI Tools for Education</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://aitoolsedu.com/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
...
<!-- Cached page generated by WP-Super-Cache on 2024-01-06 01:41:44 -->
